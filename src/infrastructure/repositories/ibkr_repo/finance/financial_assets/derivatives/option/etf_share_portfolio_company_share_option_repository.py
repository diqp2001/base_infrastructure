...
from infrastructure.repositories.mappers.finance.financial_assets.share.etf_share_portfolio_company_share_option_mapper import ETFSharePortfolioCompanyShareOptionMapper
...
class IBKRETFSharePortfolioCompanyShareOptionRepository(IBKRFinancialAssetRepository,ETFSharePortfolioCompanyShareOptionPort):
    ...
    def _create_or_get(self, symbol: str = None, strike_price: float = None, expiry: str = None, option_type: str = None, **kwargs) -> Optional[ETFSharePortfolioCompanyShareOption]:
        """
        Get or create an ETF share portfolio company share option by symbol and parameters using IBKR API.
