...
from infrastructure.repositories.mappers.finance.financial_assets.share.etf_share_portfolio_company_share_mapper import ETFSharePortfolioCompanyShareMapper
