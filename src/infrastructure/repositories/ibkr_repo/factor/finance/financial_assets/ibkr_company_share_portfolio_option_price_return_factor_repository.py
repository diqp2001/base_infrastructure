...
from src.domain.ports.factor.finance.financial_assets.derivatives.option.company_share_portfolio_option.company_share_portfolio_option_price_return_factor_port import CompanySharePortfolioOptionPriceReturnFactorPort
from src.infrastructure.repositories.ibkr_repo.factor.base_ibkr_factor_repository import BaseIBKRFactorRepository


class IBKRPortfolioCompanyShareOptionPriceReturnFactorRepository(BaseIBKRFactorRepository, CompanySharePortfolioOptionPriceReturnFactorPort):
    """
    ...
    def __init__(self, ibkr_client, factory=None):
        ...
        if self.factory:
            self.local_repo = self.factory._local_repositories.get('company_share_portfolio_option_price_return_factor')
