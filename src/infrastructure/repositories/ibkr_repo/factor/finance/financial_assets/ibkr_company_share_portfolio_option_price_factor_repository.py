...
class IBKRCompanySharePortfolioOptionPriceFactorRepository(BaseIBKRFactorRepository, CompanySharePortfolioOptionPriceFactorPort):
    """
    ...
    def __init__(self, ibkr_client, factory=None):
        ...
        if self.factory:
            self.local_repo = self.factory._local_repositories.get('company_share_portfolio_option_price_factor')
