"""
Repository class for Portfolio Company Share Holding Quantity factor entities.
"""
...
from src.domain.entities.factor.finance.holding.portfolio_company_share_holding_quantity_factor import PortfolioCompanyShareHoldingQuantityFactor
...
class PortfolioCompanyShareHoldingQuantityFactorRepository(BaseFactorRepository):
    ...
    def _to_entity(self, infra_obj):
        ...
        return FactorMapper.to_domain_portfolio_company_share_holding_quantity_factor(infra_obj)
    ...
    def get_or_create(self, primary_key: str, **kwargs):
        """
        Get or create a portfolio company share holding quantity factor with dependency resolution.
        ...
        try:
            ...
            return self._create_or_get(
                ...
                definition=kwargs.get('definition', f'Portfolio company share holding quantity factor: {primary_key}'),
                entity_type=kwargs.get('entity_type', 'portfolio_company_share_holding_quantity')
            )
            
        except Exception as e:
            print(f"Error in get_or_create for portfolio company share holding quantity factor {primary_key}: {e}")
            return None