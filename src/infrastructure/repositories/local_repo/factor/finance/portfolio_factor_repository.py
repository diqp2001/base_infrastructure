"""
Repository class for Portfolio factor entities.
"""
...
class PortfolioFactorRepository(BaseFactorRepository):
    """Repository for Portfolio factor entities with CRUD operations."""
    ...
    def _to_entity(self, infra_obj):
        ...
        return FactorMapper.to_domain_portfolio_factor(infra_obj)
    ...
    def get_or_create(self,entity_cls, primary_key: str, **kwargs):
        """
        Get or create a portfolio factor with dependency resolution.
        ...
        try:
            ...
            return self._create_or_get(
                ...
                definition=kwargs.get('definition', f'Portfolio factor: {primary_key}'),
                entity_type=kwargs.get('entity_type', 'portfolio')
            )
            
        except Exception as e:
            print(f"Error in get_or_create for portfolio factor {primary_key}: {e}")
            return None