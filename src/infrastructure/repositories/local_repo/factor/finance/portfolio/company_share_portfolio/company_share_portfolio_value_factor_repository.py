"""
Company Share Portfolio Value Factor Repository

Local repository for company share portfolio value factor entities using SQLAlchemy.
"""
...
class CompanySharePortfolioValueFactorRepository(BaseFactorRepository, CompanySharePortfolioValueFactorPort):
    """Local repository for company share portfolio value factor entities."""

    def __init__(self, session: Session, factory=None):
        super().__init__(session)
        self.factory = factory
        self.mapper = CompanySharePortfolioValueFactorMapper()
    ...
    def _create_or_get(self, entity_cls, primary_key: str, **kwargs):
        """
        Get or create a company share portfolio value factor with dependency resolution.
        ...
        try:
            ...
            existing = self.get_by_all(
                ...
                factor_type=kwargs.get('factor_type', 'company_share_portfolio_value_factor')
            )
            if existing:
            ...
            # This ensures factor_type is properly set
            ...
            print(f"Error in get_or_create company share portfolio value factor {primary_key}: {e}")
            return None
    ...
    def get_by_all(
        ...
        try:
            ...
            print(f"Error retrieving company share portfolio value factor by all attributes: {e}")
            return None
