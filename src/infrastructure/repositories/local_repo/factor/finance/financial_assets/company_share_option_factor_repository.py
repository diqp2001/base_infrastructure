...
from src.infrastructure.repositories.mappers.factor.company_share_option_factor_mapper import CompanyShareOptionFactorMapper
from src.infrastructure.repositories.mappers.factor.factor_value_mapper import FactorValueMapper
from ...base_factor_repository import BaseFactorRepository


class CompanyShareOptionFactorRepository(BaseFactorRepository):
    """Repository for Company Share Option factor entities with CRUD operations."""
    
    def __init__(self, session: Session, factory=None):
        super().__init__(session)
        self.factory = factory
        self.mapper = CompanyShareOptionFactorMapper()
    ...
    def _create_or_get(self, entity_cls,primary_key: str, **kwargs):
        """
        Get or create a company share option factor with dependency resolution.
        ...
        try:
            ...
            print(f"Error in get_or_create for company share option factor {primary_key}: {e}")
            return None
