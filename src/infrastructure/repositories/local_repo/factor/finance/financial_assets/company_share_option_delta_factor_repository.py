...
from infrastructure.repositories.mappers.factor.finance.financial_assets.derivatives.option.company_share_option.company_share_option_delta_factor_mapper import CompanyShareOptionDeltaFactorMapper
