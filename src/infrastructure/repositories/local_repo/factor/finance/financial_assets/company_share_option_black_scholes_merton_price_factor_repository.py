...
from infrastructure.repositories.mappers.factor.finance.financial_assets.derivatives.option.company_share_option.company_share_option_black_scholes_merton_price_factor_mapper import CompanyShareOptionBlackScholesMertonPriceFactorMapper
