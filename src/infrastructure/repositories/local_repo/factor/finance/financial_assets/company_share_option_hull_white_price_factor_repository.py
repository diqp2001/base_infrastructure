"""
Repository class for Company Share Option Hull White Price factor entities.
"""
...
from src.infrastructure.repositories.mappers.factor.company_share_option_hull_white_price_factor_mapper import CompanyShareOptionHullWhitePriceFactorMapper
from src.infrastructure.repositories.mappers.factor.factor_value_mapper import FactorValueMapper
from ...base_factor_repository import BaseFactorRepository


class CompanyShareOptionHullWhitePriceFactorRepository(BaseFactorRepository, CompanyShareOptionHullWhitePriceFactorPort):
    """Repository for Company Share Option Hull White Price factor entities with CRUD operations."""
    
    def __init__(self, session: Session, factory=None):
        super().__init__(session)
        self.factory = factory
        self.mapper = CompanyShareOptionHullWhitePriceFactorMapper()
    ...
    def _create_or_get(self, entity_cls,primary_key: str, **kwargs):
        """
        Get or create a company share option hull white price factor with dependency resolution.
        ...
        try:
            ...
            existing = self.get_by_all(
                ...
                factor_type=kwargs.get('factor_type', 'company_share_option_hull_white_price_factor'),
            ...
            print(f"Error in get_or_create for company share option hull white price factor {primary_key}: {e}")
            return None
    ...
    def get_by_all(
        ...
        try:
            ...
            print(f"Error retrieving company share option hull white price factor by all attributes: {e}")
            return None