"""
Repository class for Portfolio Company Share Option factor entities.
"""

from typing import Optional
from sqlalchemy.orm import Session
from src.domain.entities.factor.factor_dependency import FactorDependency
from infrastructure.repositories.mappers.factor.finance.financial_assets.derivatives.option.company_share_portfolio_option.portfolio_company_share_option_factor_mapper import PortfolioCompanyShareOptionFactorMapper
from src.infrastructure.repositories.mappers.factor.factor_value_mapper import FactorValueMapper
from ...base_factor_repository import BaseFactorRepository


class PortfolioCompanyShareOptionFactorRepository(BaseFactorRepository):
    """Repository for Portfolio Company Share Option factor entities with CRUD operations."""
    
    def __init__(self, session: Session, factory=None):
        super().__init__(session)
        self.factory = factory
        self.mapper = PortfolioCompanyShareOptionFactorMapper()
    ...
    def _create_or_get(self, entity_cls,primary_key: str, **kwargs):
        """
        Get or create a portfolio company share option factor with dependency resolution.
        ...
        try:
            ...
            print(f"Error in get_or_create for portfolio company share option factor {primary_key}: {e}")
            return None
    ...
    def get_by_all(
        ...
        try:
            ...
            print(f"Error retrieving portfolio company share option factor by all attributes: {e}")
            return None