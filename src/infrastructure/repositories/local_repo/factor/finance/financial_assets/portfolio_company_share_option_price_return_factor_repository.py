...
from infrastructure.repositories.mappers.factor.finance.financial_assets.derivatives.option.company_share_portfolio_option.portfolio_company_share_option_price_return_factor_mapper import PortfolioCompanyShareOptionPriceReturnFactorMapper
