...
from src.infrastructure.repositories.mappers.factor.finance.financial_assets.index.index_factor_mapper import IndexFactorMapper
    ...
    def _create_or_get(self, entity_cls, primary_key: str, **kwargs):
        ...
        try:
            ...
            existing = self.get_by_all(name =primary_key,
                ...
                factor_type=kwargs.get('factor_type', 'index_factor'))
            if existing:
