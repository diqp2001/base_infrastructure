"""
Repository class for ETF Share Portfolio Company Share Option factor entities.
"""
...
class ETFSharePortfolioCompanyShareOptionFactorRepository(BaseFactorRepository):
    """Repository for ETF Share Portfolio Company Share Option factor entities with CRUD operations."""
    
    def __init__(self, session: Session, factory=None):
        super().__init__(session)
        self.factory = factory
        self.mapper = ETFSharePortfolioCompanyShareOptionFactorMapper()
    ...
    def _create_or_get(self,entity_cls, primary_key: str, **kwargs):
        """
        Get or create an ETF share portfolio company share option factor with dependency resolution.
        ...
        try:
            ...
            print(f"Error in get_or_create for ETF share portfolio company share option factor {primary_key}: {e}")
            return None
    ...
    def get_by_all(
        ...
        try:
            ...
            print(f"Error retrieving ETF share portfolio company share option factor by all attributes: {e}")
            return None