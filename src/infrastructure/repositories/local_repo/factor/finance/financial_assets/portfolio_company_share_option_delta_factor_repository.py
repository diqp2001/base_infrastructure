"""
Repository class for Portfolio Company Share Option Delta factor entities.
"""
...
class PortfolioCompanyShareOptionDeltaFactorRepository(BaseFactorRepository):
    """Repository for Portfolio Company Share Option Delta factor entities with CRUD operations."""
    
    def __init__(self, session: Session, factory=None):
        super().__init__(session)
        self.factory = factory
        self.mapper = PortfolioCompanyShareOptionDeltaFactorMapper()
    ...
    def _to_entity(self, infra_obj):
        ...
        return PortfolioCompanyShareOptionDeltaFactorMapper.to_domain(infra_obj)
    ...
    def _create_or_get(self, primary_key: str, **kwargs):
        ...
        try:
            ...
            print(f"Error in get_or_create for portfolio company share option delta factor {primary_key}: {e}")
            return None
    ...
    def get_by_all(
        ...
        try:
            ...
            print(f"Error retrieving portfolio company share option delta factor by all attributes: {e}")
            return None