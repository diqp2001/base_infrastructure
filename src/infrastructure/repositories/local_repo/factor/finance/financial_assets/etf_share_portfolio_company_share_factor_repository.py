"""
Repository class for ETF Share Portfolio Company Share factor entities.
"""

from typing import Optional
from sqlalchemy.orm import Session
from src.domain.entities.factor.factor_dependency import FactorDependency
from infrastructure.repositories.mappers.factor.finance.financial_assets.share.etf_share.etf_share_portfolio_company_share_factor_mapper import ETFSharePortfolioCompanyShareFactorMapper
...
class ETFSharePortfolioCompanyShareFactorRepository(BaseFactorRepository, ETFSharePortfolioCompanyShareFactorPort):
    """Repository for ETF Share Portfolio Company Share factor entities with CRUD operations."""
    
    def __init__(self, session: Session, factory=None):
        super().__init__(session)
        self.factory = factory
        self.mapper = ETFSharePortfolioCompanyShareFactorMapper()
    ...
    def _create_or_get(self, entity_cls, primary_key: str, **kwargs):
        """
        Get or create an ETF share portfolio company share factor with dependency resolution.
        ...
        try:
            ...
            existing = self.get_by_all(
                ...
                factor_type=kwargs.get('factor_type', 'etf_share_portfolio_company_share_factor')
            )
            if existing:
            ...
            print(f"Error in get_or_create etf share portfolio company share factor {primary_key}: {e}")
            return None
    ...
    def get_by_all(
        ...
        try:
            ...
            print(f"Error retrieving etf share portfolio company share factor by all attributes: {e}")
            return None
