"""
Repository class for Company Share Portfolio Option Price Return factor entities.
"""

from typing import Optional
from sqlalchemy.orm import Session
from src.domain.entities.factor.factor_dependency import FactorDependency
from src.infrastructure.repositories.mappers.factor.finance.financial_assets.derivatives.option.company_share_portfolio_option.company_share_portfolio_option_price_return_factor_mapper import CompanySharePortfolioOptionPriceReturnFactorMapper
from src.infrastructure.repositories.mappers.factor.factor_value_mapper import FactorValueMapper
from ......base_factor_repository import BaseFactorRepository


class CompanySharePortfolioOptionPriceReturnFactorRepository(BaseFactorRepository):
    """Repository for Company Share Portfolio Option Price Return factor entities with CRUD operations."""
    
    def __init__(self, session: Session, factory=None):
        super().__init__(session)
        self.factory = factory
        self.mapper = CompanySharePortfolioOptionPriceReturnFactorMapper()
    ...
    def _to_entity(self, infra_obj):
        ...
        return CompanySharePortfolioOptionPriceReturnFactorMapper.to_domain(infra_obj)
    
    def _to_model(self, entity):
        """Convert domain entity to ORM model."""
        return CompanySharePortfolioOptionPriceReturnFactorMapper.to_orm(entity)

    def _create_or_get(self,entity_cls,primary_key: str, **kwargs):
        """
        Get or create a company share portfolio option price return factor with dependency resolution.
        ...
        try:
            ...
            print(f"Error in get_or_create for company share portfolio option price return factor {primary_key}: {e}")
            return None
    ...
    def get_by_all(
        ...
        try:
            ...
            print(f"Error retrieving company share portfolio option price return factor by all attributes: {e}")
            return None