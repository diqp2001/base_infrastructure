"""
Repository class for Company Share Portfolio Option Price factor entities.
"""

from typing import Optional
from sqlalchemy.orm import Session
from src.infrastructure.repositories.mappers.factor.finance.financial_assets.derivatives.option.company_share_portfolio_option.company_share_portfolio_option_price_factor_mapper import CompanySharePortfolioOptionPriceFactorMapper
from src.infrastructure.repositories.mappers.factor.factor_value_mapper import FactorValueMapper
from ......base_factor_repository import BaseFactorRepository


class CompanySharePortfolioOptionPriceFactorRepository(BaseFactorRepository):
    """Repository for Company Share Portfolio Option Price factor entities with CRUD operations."""
    
    def __init__(self, session: Session, factory=None):
        super().__init__(session)
        self.factory = factory
        self.mapper = CompanySharePortfolioOptionPriceFactorMapper()
    ...
    def _to_entity(self, infra_obj):
        ...
        return CompanySharePortfolioOptionPriceFactorMapper.to_domain(infra_obj)
    
    def _to_model(self, entity):
        """Convert domain entity to ORM model."""
        return CompanySharePortfolioOptionPriceFactorMapper.to_orm(entity)

    def _create_or_get(self, entity_cls,primary_key: str, **kwargs):
        """
        Get or create a company share portfolio option price factor with dependency resolution.
        ...
        try:
            ...
            print(f"Error in get_or_create for company share portfolio option price factor {primary_key}: {e}")
            return None
    ...
    def get_by_all(
        ...
        try:
            ...
            print(f"Error retrieving company share portfolio option price factor by all attributes: {e}")
            return None