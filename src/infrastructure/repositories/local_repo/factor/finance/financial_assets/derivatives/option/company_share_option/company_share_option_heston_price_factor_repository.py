"""
Repository class for Company Share Option Heston Price factor entities.
"""
...
from src.infrastructure.repositories.mappers.factor.finance.financial_assets.derivatives.option.company_share_option.company_share_option_heston_price_factor_mapper import CompanyShareOptionHestonPriceFactorMapper
from src.infrastructure.repositories.mappers.factor.factor_value_mapper import FactorValueMapper
from ......base_factor_repository import BaseFactorRepository


class CompanyShareOptionHestonPriceFactorRepository(BaseFactorRepository, CompanyShareOptionHestonPriceFactorPort):
    """Repository for Company Share Option Heston Price factor entities with CRUD operations."""
    
    def __init__(self, session: Session, factory=None):
        super().__init__(session)
        self.factory = factory
        self.mapper = CompanyShareOptionHestonPriceFactorMapper()
    ...
    def _create_or_get(self, entity_cls,primary_key: str, **kwargs):
        """
        Get or create a company share option heston price factor with dependency resolution.
        ...
        try:
            ...
            existing = self.get_by_all(
                ...
                factor_type=kwargs.get('factor_type', 'company_share_option_heston_price_factor'),
            ...
            print(f"Error in get_or_create for company share option heston price factor {primary_key}: {e}")
            return None
    ...
    def get_by_all(
        ...
        try:
            ...
            print(f"Error retrieving company share option heston price factor by all attributes: {e}")
            return None