...
from src.infrastructure.repositories.mappers.factor.finance.financial_assets.derivatives.future.future_factor_mapper import FutureFactorMapper
...
class FuturesFactorRepository(BaseFactorRepository):
    ...
    def _to_entity(self, infra_obj):
        ...
        return FutureFactorMapper.to_domain(infra_obj)
