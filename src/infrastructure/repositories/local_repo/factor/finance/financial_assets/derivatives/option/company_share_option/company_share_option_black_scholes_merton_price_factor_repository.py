"""
Repository class for Company Share Option Black Scholes Merton Price factor entities.
"""

from typing import Optional
from sqlalchemy.orm import Session
from src.domain.entities.factor.factor_dependency import FactorDependency
from src.domain.ports.factor.finance.financial_assets.derivatives.option.company_share_option.company_share_option_black_scholes_merton_price_factor_port import CompanyShareOptionBlackScholesMertonPriceFactorPort
from src.infrastructure.repositories.mappers.factor.finance.financial_assets.derivatives.option.company_share_option.company_share_option_black_scholes_merton_price_factor_mapper import CompanyShareOptionBlackScholesMertonPriceFactorMapper
from src.infrastructure.repositories.mappers.factor.factor_value_mapper import FactorValueMapper
from ......base_factor_repository import BaseFactorRepository


class CompanyShareOptionBlackScholesMertonPriceFactorRepository(BaseFactorRepository, CompanyShareOptionBlackScholesMertonPriceFactorPort):
    """Repository for Company Share Option Black Scholes Merton Price factor entities with CRUD operations."""
    
    def __init__(self, session: Session, factory=None):
        super().__init__(session)
        self.factory = factory
        self.mapper = CompanyShareOptionBlackScholesMertonPriceFactorMapper()
    ...
    def _create_or_get(self, entity_cls,primary_key: str, **kwargs):
        """
        Get or create a company share option black scholes merton price factor with dependency resolution.
        ...
        try:
            ...
            existing = self.get_by_all(
                ...
                factor_type=kwargs.get('factor_type', 'company_share_option_black_scholes_merton_price_factor'),
            ...
            print(f"Error in get_or_create for company share option black scholes merton price factor {primary_key}: {e}")
            return None
    ...
    def get_by_all(
        ...
        try:
            ...
            print(f"Error retrieving company share option black scholes merton price factor by all attributes: {e}")
            return None