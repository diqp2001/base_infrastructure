...
from src.infrastructure.repositories.mappers.factor.finance.financial_assets.derivatives.option.company_share_option.company_share_option_implied_corr_factor_mapper import CompanyShareOptionImpliedCorrFactorMapper
from src.infrastructure.repositories.mappers.factor.factor_value_mapper import FactorValueMapper
from src.domain.ports.factor.finance.financial_assets.derivatives.option.company_share_option.company_share_option_implied_corr_factor_port import CompanyShareOptionImpliedCorrFactorPort
from ......base_factor_repository import BaseFactorRepository


class CompanyShareOptionImpliedCorrFactorRepository(BaseFactorRepository, CompanyShareOptionImpliedCorrFactorPort):

    def __init__(self, session: Session, factory=None):
        super().__init__(session)
        self.factory = factory
        self.mapper = CompanyShareOptionImpliedCorrFactorMapper()
    ...
    def _create_or_get(self, entity_cls, primary_key: str, **kwargs):
        try:
            existing = self.get_by_all(
                ...
                factor_type=kwargs.get('factor_type') or 'company_share_option_implied_corr_factor',
            )
            if existing:
            ...
            domain_factor = self.get_factor_entity()(
                ...
                definition=kwargs.get('definition') or f'CompanyShareOptionImpliedCorrFactor: {primary_key}',
            )
            ...
            print(f"Error in _create_or_get CompanyShareOptionImpliedCorrFactor {primary_key}: {e}")
            return None
    ...
    def get_by_all(self, name: str, group: str, factor_type: str = None,
        ...
        try:
            ...
            print(f"Error retrieving CompanyShareOptionImpliedCorrFactor by all attributes: {e}")
            return None
