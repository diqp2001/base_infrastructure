"""
Repository class for Company Share Option Cox Ross Rubinstein Price factor entities.
"""
...
from src.infrastructure.repositories.mappers.factor.finance.financial_assets.derivatives.option.company_share_option.company_share_option_cox_ross_rubinstein_price_factor_mapper import CompanyShareOptionCoxRossRubinsteinPriceFactorMapper
from src.infrastructure.repositories.mappers.factor.factor_value_mapper import FactorValueMapper
from ......base_factor_repository import BaseFactorRepository


class CompanyShareOptionCoxRossRubinsteinPriceFactorRepository(BaseFactorRepository, CompanyShareOptionCoxRossRubinsteinPriceFactorPort):
    """Repository for Company Share Option Cox Ross Rubinstein Price factor entities with CRUD operations."""
    
    def __init__(self, session: Session, factory=None):
        super().__init__(session)
        self.factory = factory
        self.mapper = CompanyShareOptionCoxRossRubinsteinPriceFactorMapper()
    ...
    def _create_or_get(self, entity_cls,primary_key: str, **kwargs):
        """
        Get or create a company share option cox ross rubinstein price factor with dependency resolution.
        ...
        try:
            ...
            existing = self.get_by_all(
                ...
                factor_type=kwargs.get('factor_type', 'company_share_option_cox_ross_rubinstein_price_factor'),
            ...
            print(f"Error in get_or_create for company share option cox ross rubinstein price factor {primary_key}: {e}")
            return None
    ...
    def get_by_all(
        ...
        try:
            ...
            print(f"Error retrieving company share option cox ross rubinstein price factor by all attributes: {e}")
            return None