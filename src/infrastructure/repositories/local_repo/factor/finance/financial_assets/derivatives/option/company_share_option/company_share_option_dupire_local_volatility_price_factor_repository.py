"""
Repository class for Company Share Option Dupire Local Volatility Price factor entities.
"""

from typing import Optional
from sqlalchemy.orm import Session
from src.domain.entities.factor.factor_dependency import FactorDependency
from src.domain.ports.factor.finance.financial_assets.derivatives.option.company_share_option.company_share_option_dupire_local_volatility_price_factor_port import CompanyShareOptionDupireLocalVolatilityPriceFactorPort
from src.infrastructure.repositories.mappers.factor.finance.financial_assets.derivatives.option.company_share_option.company_share_option_dupire_local_volatility_price_factor_mapper import CompanyShareOptionDupireLocalVolatilityPriceFactorMapper
from src.infrastructure.repositories.mappers.factor.factor_value_mapper import FactorValueMapper
from ......base_factor_repository import BaseFactorRepository


class CompanyShareOptionDupireLocalVolatilityPriceFactorRepository(BaseFactorRepository, CompanyShareOptionDupireLocalVolatilityPriceFactorPort):
    """Repository for Company Share Option Dupire Local Volatility Price factor entities with CRUD operations."""
    
    def __init__(self, session: Session, factory=None):
        super().__init__(session)
        self.factory = factory
        self.mapper = CompanyShareOptionDupireLocalVolatilityPriceFactorMapper()
    ...
    def _create_or_get(self, entity_cls,primary_key: str, **kwargs):
        """
        Get or create a company share option dupire local volatility price factor with dependency resolution.
        ...
        try:
            ...
            existing = self.get_by_all(
                ...
                subgroup=kwargs.get('subgroup', 'option_price'),
                factor_type=kwargs.get('factor_type', 'company_share_option_dupire_local_volatility_price_factor'),
            ...
            print(f"Error in get_or_create for company share option dupire local volatility price factor {primary_key}: {e}")
            return None
    ...
    def get_by_all(
        ...
        try:
            ...
            print(f"Error retrieving company share option dupire local volatility price factor by all attributes: {e}")
            return None