...
from src.infrastructure.repositories.mappers.factor.finance.financial_assets.derivatives.future.future_price_return_factor_mapper import FuturePriceReturnFactorMapper
    ...
    def _create_or_get(self,entity_cls, primary_key: str, **kwargs):
        ...
        try:
            ...
            existing = self.get_by_all(
                ...
                factor_type=kwargs.get('factor_type', 'future_price_return_factor')
            )
            if existing:
