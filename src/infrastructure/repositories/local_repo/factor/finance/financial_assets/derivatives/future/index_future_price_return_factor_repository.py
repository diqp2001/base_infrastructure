...
from src.infrastructure.repositories.mappers.factor.finance.financial_assets.derivatives.future.index.index_future_price_return_factor_mapper import IndexFuturePriceReturnFactorMapper
