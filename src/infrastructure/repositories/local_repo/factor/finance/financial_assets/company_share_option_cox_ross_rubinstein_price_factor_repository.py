...
from infrastructure.repositories.mappers.factor.finance.financial_assets.derivatives.option.company_share_option.company_share_option_cox_ross_rubinstein_price_factor_mapper import CompanyShareOptionCoxRossRubinsteinPriceFactorMapper
