...
from src.infrastructure.repositories.mappers.factor.equity_factor_mapper import EquityFactorMapper
...
class EquityFactorRepository(BaseFactorRepository):
    ...
    def _to_entity(self, infra_obj):
        ...
        return EquityFactorMapper.to_domain(infra_obj)
    
    def _to_model(self, entity):
        """Convert domain entity to ORM model."""
        return EquityFactorMapper.to_orm(entity)
