...
class CompanySharePortfolioOptionDeltaFactorRepository(BaseFactorRepository):
    """Repository for Company Share Portfolio Option Delta factor entities with CRUD operations."""
    
    def __init__(self, session: Session, factory=None):
        super().__init__(session)
        self.factory = factory
        self.mapper = CompanySharePortfolioOptionDeltaFactorMapper()
    ...
    def _to_entity(self, infra_obj):
        ...
        return CompanySharePortfolioOptionDeltaFactorMapper.to_domain(infra_obj)
    
    def _to_model(self, entity):
        """Convert domain entity to ORM model."""
        return CompanySharePortfolioOptionDeltaFactorMapper.to_orm(entity)

    def _create_or_get(self,entity_cls, primary_key: str, **kwargs):
        """
        Get or create a company share portfolio option delta factor with dependency resolution.
        ...
        try:
            ...
            print(f"Error in get_or_create for company share portfolio option delta factor {primary_key}: {e}")
            return None
    ...
    def get_by_all(
        ...
        try:
            ...
            print(f"Error retrieving company share portfolio option delta factor by all attributes: {e}")
            return None