"""
Repository class for Holding factor entities.
"""
...
class HoldingFactorRepository(BaseFactorRepository):
    """Repository for Holding factor entities with CRUD operations."""
    ...
    def _to_entity(self, infra_obj):
        ...
        return FactorMapper.to_domain_holding_factor(infra_obj)
    ...
    def get_or_create(self, entity_cls,primary_key: str, **kwargs):
        ...
        try:
            ...
            return self._create_or_get(
                ...
                source=kwargs.get('source', 'holding_analysis'),
                definition=kwargs.get('definition', f'Holding factor: {primary_key}'),
                entity_type=kwargs.get('entity_type', 'holding')
            )
            
        except Exception as e:
            print(f"Error in get_or_create for holding factor {primary_key}: {e}")
            return None