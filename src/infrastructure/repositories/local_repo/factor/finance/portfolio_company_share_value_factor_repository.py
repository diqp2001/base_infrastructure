...
from src.domain.entities.factor.finance.portfolio.portfolio_company_share_factor.portfolio_company_share_value_factor import PortfolioCompanyShareValueFactor


class PortfolioCompanyShareValueFactorRepository(BaseFactorRepository):
