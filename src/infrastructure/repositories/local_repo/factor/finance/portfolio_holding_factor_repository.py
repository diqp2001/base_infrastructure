"""
Repository class for Portfolio Holding factor entities.
"""
...
class PortfolioHoldingFactorRepository(BaseFactorRepository):
    """Repository for Portfolio Holding factor entities with CRUD operations."""
    ...
    def _to_entity(self, infra_obj):
        ...
        return FactorMapper.to_domain_portfolio_holding_factor(infra_obj)
    ...
    def get_or_create(self, primary_key: str, **kwargs):
        """
        Get or create a portfolio holding factor with dependency resolution.
        ...
        try:
            ...
            return self._create_or_get(
                ...
                entity_type=kwargs.get('entity_type', 'portfolio_holding')
            )
            
        except Exception as e:
            print(f"Error in get_or_create for portfolio holding factor {primary_key}: {e}")
            return None