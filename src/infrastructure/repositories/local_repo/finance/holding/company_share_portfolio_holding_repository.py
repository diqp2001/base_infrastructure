...
class CompanySharePortfolioHoldingRepository(BaseLocalRepository, CompanySharePortfolioHoldingPort):
    ...
    def get_by_portfolio_company_share_id(self, portfolio_id: int) -> List[CompanySharePortfolioHoldingModel]:
    ...
    def get_or_create(self, primary_key: str, **kwargs) -> Optional[CompanySharePortfolioHolding]:
        """
        ...
        try:
            ...
            existing = self.session.query(CompanySharePortfolioHoldingModel).filter_by(
            ...
            new_holding = CompanySharePortfolioHolding(
                portfolio_company_share_id=portfolio_company_share_id,
                date=holding_date,
