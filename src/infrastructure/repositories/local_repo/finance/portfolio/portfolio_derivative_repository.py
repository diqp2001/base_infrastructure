...
from src.domain.ports.finance.portfolio.portfolio_derivative_port import PortfolioDerivativePort
from src.infrastructure.repositories.mappers.finance.portfolio.portfolio_derivative_mapper import PortfolioDerivativeMapper


class PortfolioDerivativeRepository(PortfolioDerivativePort):

    def __init__(self, session: Session, factory=None):
        self.session = session
        self.factory = factory
        self.mapper = PortfolioDerivativeMapper()
    ...
    # CREATE OR GET
    # -------------------------
    def _create_or_get(self, name: str, **kwargs) -> Optional[PortfolioDerivative]:
        ...
        try:
            ...
            print(f"Error creating portfolio derivative {name}: {e}")
            return None
