...
from infrastructure.models.finance.portfolio.portfolio_company_share_option import PortfolioCompanyShareOptionModel as PortfolioCompanyShareOptionModel
