"""
Mapper for StockTimeSeries domain entity and ORM model.
...
class StockTimeSeriesMapper:
    """Mapper for StockTimeSeries domain entity and ORM model."""

    @staticmethod
    def to_domain(orm_obj: ORMStockTimeSeries) -> DomainStockTimeSeries:
        """Convert ORM model to domain entity."""
        domain_entity = DomainStockTimeSeries(
            id=orm_obj.id,
            name=orm_obj.name,
            stock_id=getattr(orm_obj, 'stock_id', None),
    ...
    @staticmethod
    def to_orm(domain_obj: DomainStockTimeSeries, orm_obj: Optional[ORMStockTimeSeries] = None) -> ORMStockTimeSeries:
        """Convert domain entity to ORM model."""
        if orm_obj is None:
            orm_obj = ORMStockTimeSeries(
                name=domain_obj.name,
                stock_id=getattr(domain_obj, 'stock_id', None),
        ...
        orm_obj.stock_id = getattr(domain_obj, 'stock_id', None)
