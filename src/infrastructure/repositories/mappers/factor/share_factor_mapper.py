...
class ShareFactorMapper(BaseFactorMapper):
    """Mapper for ShareFactor domain entity and ORM model conversion."""
    ...
    @classmethod
    def to_domain(cls, orm_model: Optional[FactorModel]) -> Optional[ShareFactor]:
    ...
    @classmethod
    def to_orm(cls, domain_entity: ShareFactor) -> FactorModel:
