...
from src.infrastructure.models.factor.factor import CompanySharePriceReturnFactorModel
...
class CompanySharePriceReturnFactorMapper(BaseFactorMapper):
    ...
    @staticmethod
    def to_domain(orm_model: Optional[CompanySharePriceReturnFactorModel]) -> Optional[CompanySharePriceReturnFactor]:
    ...
    @staticmethod
    def to_orm(domain_entity: CompanySharePriceReturnFactor) -> CompanySharePriceReturnFactorModel:
