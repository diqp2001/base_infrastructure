...
class FutureFactorMapper(BaseFactorMapper):
    ...
    @classmethod
    def to_domain(cls, orm_model: Optional[FactorModel]) -> Optional[FutureFactor]:
        """Convert ORM model to FutureFactor domain entity."""
        if not orm_model:
            return None
    ...
    @classmethod
    def to_orm(cls, domain_entity: FutureFactor) -> FactorModel:
        """Convert FutureFactor domain entity to ORM model."""
        return FactorModel(
            id=domain_entity.id,
