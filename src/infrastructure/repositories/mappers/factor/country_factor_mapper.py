"""
Mapper for CountryFactor domain entity and ORM model conversion.
"""
...
class CountryFactorMapper(BaseFactorMapper):
    """Mapper for CountryFactor domain entity and ORM model conversion."""
    ...
    @classmethod
    def to_domain(cls, orm_model: Optional[FactorModel]) -> Optional[CountryFactor]:
    ...
    @classmethod
    def to_orm(cls, domain_entity: CountryFactor) -> FactorModel:
