...
class ShareTechnicalFactorMapper(BaseFactorMapper):
    ...
    @classmethod
    def to_domain(cls, orm_model: Optional[FactorModel]) -> Optional[ShareTechnicalFactor]:
        """Convert ORM model to ShareTechnicalFactor domain entity."""
        if not orm_model:
            return None
    ...
    @classmethod
    def to_orm(cls, domain_entity: ShareTechnicalFactor) -> FactorModel:
        """Convert ShareTechnicalFactor domain entity to ORM model."""
        return FactorModel(
            id=domain_entity.id,
