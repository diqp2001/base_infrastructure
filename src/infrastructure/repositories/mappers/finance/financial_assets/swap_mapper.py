"""
Mapper for Swap domain entity and ORM model.
...
from src.domain.entities.finance.financial_assets.derivatives.swap import Swap as DomainSwap
from src.infrastructure.models.finance.financial_assets.derivative.swap.swap import SwapModel as ORMSwap
...
class SwapMapper:
    ...
    @staticmethod
    def to_domain(orm_obj: ORMSwap) -> DomainSwap:
        """Convert ORM model to domain entity."""
        domain_entity = DomainSwap(
            id=orm_obj.id,
    ...
    @staticmethod
    def to_orm(domain_obj: DomainSwap, orm_obj: Optional[ORMSwap] = None) -> ORMSwap:
