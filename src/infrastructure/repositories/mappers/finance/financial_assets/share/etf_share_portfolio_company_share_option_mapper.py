"""
Mapper for ETFSharePortfolioCompanyShareOption domain entity and ORM model.
...
from src.domain.entities.finance.financial_assets.derivatives.option.etf_share_portfolio_company_share_option import ETFSharePortfolioCompanyShareOption as DomainETFSharePortfolioCompanyShareOption
from src.infrastructure.models.finance.financial_assets.derivative.option.etf_share_portfolio_company_share_option import ETFSharePortfolioCompanyShareOptionModel as ORMETFSharePortfolioCompanyShareOption


class ETFSharePortfolioCompanyShareOptionMapper:
    """Mapper for ETFSharePortfolioCompanyShareOption domain entity and ORM model."""

    @staticmethod
    def to_domain(orm_obj: ORMETFSharePortfolioCompanyShareOption) -> DomainETFSharePortfolioCompanyShareOption:
        """Convert ORM model to domain entity."""
        domain_entity = DomainETFSharePortfolioCompanyShareOption(
            id=orm_obj.id,
    ...
    @staticmethod
    def to_orm(domain_obj: DomainETFSharePortfolioCompanyShareOption, orm_obj: Optional[ORMETFSharePortfolioCompanyShareOption] = None) -> ORMETFSharePortfolioCompanyShareOption:
        """Convert domain entity to ORM model."""
        if orm_obj is None:
            orm_obj = ORMETFSharePortfolioCompanyShareOption()
        
        # Map basic fields
        orm_obj.id = domain_obj.id
        
        # Map ETF share portfolio company share option specific fields
