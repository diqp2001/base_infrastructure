"""
Mapper for Crypto domain entity and ORM model.
...
from src.domain.entities.finance.financial_assets.crypto import Crypto as DomainCrypto
from src.infrastructure.models.finance.financial_assets.crypto import CryptoModel as ORMCrypto
...
class CryptoMapper:
    ...
    @staticmethod
    def to_domain(orm_obj: ORMCrypto) -> DomainCrypto:
        """Convert ORM model to domain entity."""
        domain_entity = DomainCrypto(
            id=orm_obj.id,
    ...
    @staticmethod
    def to_orm(domain_obj: DomainCrypto, orm_obj: Optional[ORMCrypto] = None) -> ORMCrypto:
