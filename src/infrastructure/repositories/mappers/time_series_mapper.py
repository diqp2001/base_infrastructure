"""
Mapper for TimeSeries domain entity and ORM model.
...
from src.domain.entities.time_series.time_series import TimeSeries as DomainTimeSeries
from src.infrastructure.models.time_series.time_series import TimeSeriesModel as ORMTimeSeries
...
class TimeSeriesMapper:
    ...
    @staticmethod
    def to_domain(orm_obj: ORMTimeSeries) -> DomainTimeSeries:
        """Convert ORM model to domain entity."""
        domain_entity = DomainTimeSeries(
            id=orm_obj.id,
            name=orm_obj.name,
            series_type=orm_obj.series_type,
    ...
    @staticmethod
    def to_orm(domain_obj: DomainTimeSeries, orm_obj: Optional[ORMTimeSeries] = None) -> ORMTimeSeries:
        """Convert domain entity to ORM model."""
        if orm_obj is None:
            orm_obj = ORMTimeSeries(
                name=domain_obj.name,
                series_type=domain_obj.series_type,
        ...
        orm_obj.series_type = domain_obj.series_type
