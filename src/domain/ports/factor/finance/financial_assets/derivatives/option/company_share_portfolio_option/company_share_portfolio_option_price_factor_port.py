...
class CompanySharePortfolioOptionPriceFactorPort(ABC):
    ...
    @abstractmethod
    def get_by_id(self, id: int) -> Optional[CompanySharePortfolioOptionPriceFactor]: ...
    ...
    @abstractmethod
    def _create_or_get(self, entity_cls, primary_key: str, **kwargs) -> Optional[CompanySharePortfolioOptionPriceFactor]: ...
