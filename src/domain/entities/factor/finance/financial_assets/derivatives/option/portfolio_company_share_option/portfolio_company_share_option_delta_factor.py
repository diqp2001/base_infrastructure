...
class PortfolioCompanyShareOptionDeltaFactor(PortfolioCompanyShareOptionFactor):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            name="Portfolio Company Share Option Delta",
            group="Portfolio Company Share Option Greek",
            subgroup="Delta",
            data_type="float",
            source="model",
            definition="Rate of change of portfolio company share option value with respect to underlying stock price.",
            factor_id=factor_id,
            **kwargs,
        )
