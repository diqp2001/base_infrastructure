...
"""
CompanyStock class linking stocks to companies with enhanced domain model.
Extends Stock with company-specific relationships and business logic.
"""

from typing import Optional
from datetime import datetime
from decimal import Decimal
from .stock import Stock, FundamentalData, MarketData


class CompanyStock(Stock):
    """
    CompanyStock extends Stock to link securities with company entities.
...
class CompanyStockLegacy:
    """Legacy CompanyStock class for backwards compatibility."""
