"""
Equity base class following QuantConnect architecture.
Serves as intermediate class between Security and Share-based instruments.
"""
...
class Equity(Security, ABC):
    """
    Base class for equity securities (shares).
    Intermediate class between Security and share-based instruments.
    """
    ...
    def calculate_margin_requirement(self, quantity: Decimal) -> Decimal:
        ...
        Typically 50% for long equity positions, 150% for short.
        """
    ...
    def get_contract_multiplier(self) -> Decimal:
        """Equities have a contract multiplier of 1."""
        return Decimal('1')