...
class TensorSplitterManager:
    ...
    def _create_fallback_univariate_splitter(self,
        ...
        return UnivariateTrainValTestSplitterService(data=fallback_series,timesteps=timesteps,encoder_length=None,use_asset_info_as_feature=True,scaling=None,batch_size=64)
