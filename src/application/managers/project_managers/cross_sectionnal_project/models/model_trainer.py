"""
Model training pipeline for  models.

Coordinates the training of  models with factor-enhanced data

"""

"""
Should be be called from the on data function passed trought to misbuffet engine, or algorithm
"""
...
class ModelTrainer:
    """
    Training pipeline manager for models.
    
    Orchestrates data preparation,  and model training
    ...
    # def get_model(self,model_type: str = 'both',):
    ...
    def train_complete_pipeline(self,
        ...
        Args:
            ...
            model_type: 'tft', 'mlp', or 'both', or "gbm"
        ...
        training_results = self._train_models(normalized_factor_data, model_type, seeds)
    ...
    def _normalize_and_enhance_factors(self, factor_data: Dict[str, pd.DataFrame]) -> Dict[str, pd.DataFrame]:
        ...
        This method is inserted between _prepare_factor_data 
    ...
    def _train_models(self, normalized_factor_data: Dict[str, Any], model_type: str, seeds: List[int]) -> Dict[str, Any]:
        ...
        mlp_results = self.model.train_rolling_window_models(
            data_splitter=normalized_factor_data, 
            date_range=date_range,
            model_type=model_type,
            seeds=seeds
        )
        training_results[model_type] = mlp_results
