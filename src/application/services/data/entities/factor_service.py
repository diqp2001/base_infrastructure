...
class FactorService(EntityService):
    ...
    def __init__(self, database_service: Optional[DatabaseService] = None, db_type: str = 'sqlite'):
        ...
        self.base_factor_repository = BaseFactorRepository(self.session)
        self.share_factor_repository = ShareFactorRepository(self.session)
        self.company_share_repository = CompanyShareRepositoryLocal(self.session)
